...
function AllCourses() {
    ...
    return (
        <div className='flex min-h-screen bg-gray-50'>
            ...
            <aside className="w-[260px] h-screen overflow-y-auto bg-black fixed top-0 left-0 p-6 py-[130px] border-r border-gray-200 shadow-md transition-transfrom duration-300 z-5">
